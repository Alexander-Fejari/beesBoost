...
// POST
router.post('/addCompany', /*authenticateToken,*/ company_controller_1.default.createCompany); // Swagger à faire + Ajouter protection si élements manquants + Protection si nom déjà utilisé
// GET
