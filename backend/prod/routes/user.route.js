...
router.put(`/user/updatePreferedLanguage/:param`, auth_middleware_1.authenticateToken, (req, res) => user_controller_1.default.updateField(req, res, `prefered_language`)); // Swagger à faire
// ----------------------------------------------------------- WORKER -----------------------------------------------------------
// GET WORKER INFOS
...
// UPDATE WORKER INFOS
router.put(`/worker/updateIsAdmin/:param`, auth_middleware_1.authenticateToken, (req, res) => user_controller_1.default.updateWorkerIsAdmin(req, res));
router.put(`/worker/updateCompany/:param`, auth_middleware_1.authenticateToken, (req, res) => user_controller_1.default.updateWorkerDetail(req, res, `company`));
// ----------------------------------------------------------- STUDENT -----------------------------------------------------------
// GET STUDENT INFOS
