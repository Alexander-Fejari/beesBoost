...
const worker_controller_1 = __importDefault(require("../../controllers/user/worker.controller"));
const worker_model_1 = require("../../models/user/worker.model");
...
// PUT
router.put(`/updateWorkerInfo/:param`, (req, res) => workerController.updateFields(req, res, worker_model_1.WorkerModel, [`password`, `profile_pic`, `email`, `name`, `firstname`, `occupation`, `location`, `contact_info`, `company`])); // Swagger à faire
