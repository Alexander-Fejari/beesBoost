...
const workerSchema = new mongoose_1.Schema({
    ...
    entreprise: { type: String }, // Dés que j'ai fait entreprise : Verifie si l'entreprise existe, si non la créer, et mettre ce worker en admin
    is_admin: { type: Boolean, required: true, default: false },
});
const WorkerModel = (0, mongoose_1.model)('Worker', workerSchema);
